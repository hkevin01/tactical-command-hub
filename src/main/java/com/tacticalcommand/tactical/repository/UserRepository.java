 ...
 * 
 * This repository provides data access methods for user management including authentication,
 * authorization, and user profile operations. It extends JpaRepository to provide standard CRUD
 * operations and includes custom queries for user-specific operations.
 * 
 * Key Features: - User authentication queries - Role-based user retrieval - Account status
 * management - User profile operations
 * 
...
public interface UserRepository extends JpaRepository<User, Long> {
  ...
  java.util.List<User> findByRoleName(
      @Param("roleName") com.tacticalcommand.tactical.domain.Role.RoleName roleName);
   ...
   *          the unit assignment to search for
   ...
   *          the clearance level to search for
   ...
   * 
   * @param fullName
   *          partial full name to search for
