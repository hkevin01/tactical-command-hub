package com.caribouthunder.tactical.config;

import com.caribouthunder.tactical.security.JwtAuthenticationEntryPoint;
import com.caribouthunder.tactical.security.JwtAuthenticationFilter;
 ...
 * 
 * This configuration implements JWT-based authentication with role-based authorization
 * following military security standards. It provides secure access control for
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/v1/units/**").hasAnyRole("COMMANDER", "OPERATOR", "ANALYST", "VIEWER")
