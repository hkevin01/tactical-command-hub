 ...
 * from the Authorization header. It extends OncePerRequestFilter to ensure that
 * the filter is executed only once per request, preventing multiple validations.
 * 
 * Security Features:
 ...
 * - Provides detailed logging for security audit
 * 
