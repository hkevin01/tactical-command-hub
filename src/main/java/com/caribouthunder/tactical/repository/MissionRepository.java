...
import com.caribouthunder.tactical.domain.Mission;
 ...
 * 
 * Provides comprehensive data access methods for mission management,
 * including mission planning, execution tracking, and operational queries.
 * 
...
public interface MissionRepository extends JpaRepository<Mission, Long>, 
                                          JpaSpecificationExecutor<Mission> {
     ...
     *
     * @param currentTime the current time
     * @param upcomingTime the upcoming time threshold
     ...
     *
     * @param threshold the completion threshold
     ...
     *
     * @param missionCode the mission code to check
