 ...
 * 
 * Provides comprehensive data access methods for military unit management,
 * including position tracking, status monitoring, and operational queries.
 * 
...
public interface MilitaryUnitRepository extends JpaRepository<MilitaryUnit, Long>, 
                                                JpaSpecificationExecutor<MilitaryUnit> {
     ...
     *
     * @param readinessLevel the readiness level
     ...
     *
     * @param cutoffTime the cutoff time for last contact
     ...
     */
    List<MilitaryUnit> findByCommunicationStatus(MilitaryUnit.CommunicationStatus communicationStatus);
    ...
    Page<MilitaryUnit> searchByCallsignOrName(@Param("searchTerm") String searchTerm, Pageable pageable);
