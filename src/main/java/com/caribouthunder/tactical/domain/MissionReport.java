 ...
 * 
 * This entity captures mission reports and status updates from field commanders,
 * providing real-time visibility into mission execution and progress.
 * 
 ...
 */
@Entity
@Table(name = "mission_reports", indexes = {
    @Index(name = "idx_report_mission", columnList = "mission_id"),
...
public class MissionReport extends BaseEntity {
     ...
     */
    public MissionReport(Mission mission, ReportType reportType, String reporter, String reportContent) {
        this();
