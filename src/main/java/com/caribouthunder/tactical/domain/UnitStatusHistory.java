 ...
 * 
 * This entity maintains an audit trail of all status changes for military units,
 * providing comprehensive tracking for operational analysis and reporting.
 * 
 ...
 */
@Entity
@Table(name = "unit_status_history", indexes = {
    @Index(name = "idx_status_history_unit", columnList = "unit_id"),
...
public class UnitStatusHistory extends BaseEntity {
    ...
    public String toString() {
        return "UnitStatusHistory{" +
                "id=" + getId() +
                ", unitCallsign=" + (unit != null ? unit.getCallsign() : "null") +
