 ...
 */
@Entity
@Table(name = "military_units", indexes = {
    @Index(name = "idx_unit_callsign", columnList = "callsign"),
...
public class MilitaryUnit extends BaseEntity {
     ...
     */
    public MilitaryUnit(String callsign, String unitName, UnitType unitType, OperationalDomain domain) {
        this();
